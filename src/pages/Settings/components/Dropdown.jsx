...
export default function Dropdown({name, children, isOpen, setIsOpen, setIsOtherOpen}) {

    return (
        <motion.div whileHover={{scale: 1.03}} whileTap={{scale: 0.97}} className={`dropdown${isOpen ? " open" : ""}`} onClick={() => {setIsOpen(!isOpen); setIsOtherOpen(false)}}>
